    ...
    const fetchProducts = async () => {
      try {
        ...
        if (filters.subcategory) {
          url = `https://eshopxecommbackend.vercel.app/api/products/subcategory/${filters.subcategory}`;
        } else {
          url = 'https://eshopxecommbackend.vercel.app/api/products/search';
          params = {
            category: filters.category
              ? (await axios.get('https://eshopxecommbackend.vercel.app/api/getCategoriesByCatId/' + filters.category)).data[0][0].catName
              : '',
            brand: filters.brand,
